...
@section('slidey')
    ...
    {{--<p class='description'> Tarzan, having acclimated to life in London, is called back to his former home--}}
    {{--in--}}
    ...
    {{--<p class='description'>Six children, genetically cross-bred with avian DNA, take flight around the--}}
    {{--country--}}
    ...
    {{--<p class='description'>The fate of humanity hangs in the balance as the U.S. President and citizens--}}
    {{--decide--}}
    {{--if these aliens are to be trusted ...or feared.</p></li>--}}
    {{--<li><img src="images/4.jpg" alt=" ">--}}
    {{--<p class='title'>Central Intelligence</p>--}}
    {{--<p class='description'>Bullied as a teen for being overweight, Bob Stone (Dwayne Johnson) shows up to--}}
    {{--his--}}
    ...
    {{--<p class='description'>In 1977, paranormal investigators Ed (Patrick Wilson) and Lorraine Warren come--}}
    {{--out of--}}
                            ...
                            {{--<div class="agile_tv_series_grid">--}}
                                ...
                                {{--<div class="col-md-6 agile_tv_series_grid_right">--}}
                                    ...
                                    {{--<p class="fexi_header_para"><span--}}
                                        ...
                                        {{--720p,Bluray HD Free Movie Downloads, Watch Free Movies Online with high speed--}}
                                        {{--Free--}}
                                        {{--Movie Streaming | MyDownloadTube Lorraine and Ed Warren go to north London to--}}
                                        {{--help a--}}
                                        {{--single...</p>--}}
                            ...
                            {{--<div class="agile_tv_series_grid">--}}
                                ...
                                {{--<div class="col-md-6 agile_tv_series_grid_right">--}}
                                    ...
                                    {{--<p class="fexi_header_para"><span--}}
                                        ...
                                        {{--theatre camp is used as an alternative to jail time. After she views tape ...--}}
                                    {{--</p>--}}
                        ...
                        {{--<li>--}}
                            {{--<div class="agile_tv_series_grid">--}}
                                ...
                                {{--<div class="col-md-6 agile_tv_series_grid_right">--}}
                                    ...
                                    {{--<p class="fexi_header_para"><span--}}
                                                {{--class="conjuring_w3">Story Line<label>:</label></span>--}}
                                        {{--After the Avengers leaves some&nbsp;collateral damage, political pressure mounts--}}
                                        {{--to--}}
